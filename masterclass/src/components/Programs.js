    ...
    <div className="w-full md:py-10 bg-white">
      <div className="container mx-auto px-4 lg:px-0">
        <div className="px-2 lg:pl-20 py-8 md:p-12">
          <h2 className="font-poppinsbold text-colorTextSubtitulo text-3xl lg:text-40px text-center md:text-left mb-6 md:mb-1 lg:mb-1">
            ¿Qué Incluye el Programa?
          </h2>
          <p className="font-poppinssemibold text-base text-center text-colorTextNavbar mb-12 md:text-xl lg:text-26px md:text-left">
            Beneficios para nuestra comunidad
          </p>
          <div className=" md:w-full flex flex-wrap justify-center lg:gap-x-10 lg:px-2">
            {/* Card Azul 1 */}
            <div className="w-full lg:w-[48%] lg:px-1 mb-4">
              <div className="bg-customBlue text-white rounded-lg lg:p-8 h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4 lg:mb-0">
                  ...
                  <p className="font-poppinsbold text-base md:text-2xl lg:text-3xl md:pr-20">
            ...
            <div className="w-full lg:w-[31%] lg:px-0 md:mb-4 md:my-4 mb-0 flex justify-center">
              <div className="p-4 lg:p-8 bg-colorsButton text-white rounded-lg h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4">
                  ...
                  <p className="font-poppinsbold  text-black text-base md:text-lg lg:text-2xl md:text-left pl-5 md:pl-6">
            ...
            <div className="w-full lg:w-[31%] lg:px-0 my-4 flex justify-center">
              <div className="p-6 lg:p-8 bg-colorsButton text-white rounded-lg h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4">
                  ...
                  <p className="font-poppinsbold text-black text-base md:text-lg lg:text-2xl md:text-left pl-4 md:pl-6">
            ...
            <div className="w-full lg:w-[31%] lg:px-0 md:mb-4 md:my-4 mb-0 flex justify-center">
              <div className="p-6 lg:p-8 bg-colorsButton text-white rounded-lg h-full flex flex-col justify-between">
                <div className="flex items-center mb-4">
                  ...
                  <p className="font-poppinsbold text-black text-base md:text-lg lg:text-2xl text-left pl-6">
