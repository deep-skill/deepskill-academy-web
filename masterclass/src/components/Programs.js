    ...
    <div className="w-full md:py-10 bg-white">
      <div className="container mx-auto px-4 lg:px-0">
        <div className="px-2 lg:pl-20 py-8 lg:py-1 lg:p-5 md:p-12">
          ...
          <p className="font-poppinssemibold text-lg text-center text-colorTextNavbar mb-10 md:text-xl lg:text-26px md:text-left">
            ...
            <div className="w-full lg:w-[48%] lg:px-1 mb-4">
              <div className="bg-customBlue text-white rounded-lg lg:p-8 h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4 lg:mb-0">
                  ...
                  <p className="font-poppinsbold text-xl md:text-2xl lg:text-3xl md:pr-20">
            ...
            <div className="w-full lg:w-[31%] lg:px-0 md:mb-4 md:my-4 mb-0 flex justify-center">
              <div className="p-4 lg:p-8 bg-colorsButton text-white rounded-lg h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4">
                  ...
                  <p className="font-poppinsbold  text-black text-xl md:text-lg lg:text-2xl md:text-left pl-5 md:pl-6">
            ...
            <div className="w-full lg:w-[31%] lg:px-0 my-4 flex justify-center">
              <div className="p-6 lg:p-8 bg-colorsButton text-white rounded-lg h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4">
                  ...
                  <p className="font-poppinsbold text-black text-xl md:text-lg lg:text-2xl md:text-left pl-4 md:pl-6">
            ...
            <div className="w-full lg:w-[31%] lg:px-0 md:mb-4 md:my-4 mb-0 flex justify-center">
              <div className="p-6 lg:p-8 bg-colorsButton text-white rounded-lg h-full flex flex-col justify-between">
                <div className="flex items-center mb-4">
                  ...
                  <p className="font-poppinsbold text-black text-xl md:text-lg lg:text-2xl text-left pl-6">
