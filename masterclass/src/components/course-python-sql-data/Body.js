                ...
                <div className="w-full md:w-[60%] mt-20 lg:mt-15 text-center md:text-left">
                    ...
                    <div className="flex flex-col mb-10 lg:mb-16 sm:flex-row items-center mt-12 lg:mt-10 space-y-6 md:mt-20 md:space-x-16 sm:space-y-0 sm:space-x-10">
                        ...
                        <div className="flex flex-col items-center sm:flex-row sm:items-center">
                            ...
                            <p className="text-colorText text-xl sm:text-xl md:text-base lg:text-xl xl:text-base 2xl:text-xl font-poppinsregular">Máximo 10 participantes</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="text-customBlue font-poppinsbold mt-6 w-full px-7 lg:pb-6">
                            <div className="flex items-center">
                                <div className="flex-1">
                                    ...
                                    <p className='font-poppinsmedium text-sm lg:text-base 2xl:text-lg text-colorTextNavbar text-left'>Iniciamos el 11 de julio de 2024</p>
                                </div>
                                <div className="mx-4 h-full border-l-2 border-black"></div>
                                <div className="flex-1">
                                    <h1 className='font-poppinsbold text-xl text-left'>HORARIO</h1>
                                    <p className='font-poppinsmedium lg:text-base 2xl:text-lg text-sm text-colorTextNavbar text-left'>Martes y jueves de  7 pm a 9 pm</p>
                                </div>
                            </div>
                        </div>
