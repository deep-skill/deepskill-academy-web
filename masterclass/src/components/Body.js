        ...
        <div className="bg-white p-4 w-full flex flex-col min-h-screen justify-center">
            <div className="md:pl-16 flex flex-col md:flex-row items-center md:items-start">
                <div className="w-full md:w-1/2 mt-12 text-center md:text-left">
                    <h1 className="text-customBlue text-4xl sm:text-6xl md:text-8xl font-timeburner mt-14 leading-tight">
                    ...
                    <div className="flex flex-col sm:flex-row items-center mt-12 space-y-6 md:mt-20 md:space-x-8 sm:space-y-0 sm:space-x-10">
                        <div className="flex items-center">
                            <span className="icon-[material-symbols--online-prediction] text-colorsIcon w-8 h-8 mr-2"></span>
                            <p className="text-colorText text-base sm:text-xl md:text-base ml-2 font-poppins">Online | En vivo | Remoto</p>
                        </div>
                        <div className="flex items-center">
                            <span className="icon-[material-symbols--school-outline-rounded] text-colorsIcon w-8 h-8 mr-2"></span>
                            <p className="text-colorText text-base sm:text-xl md:text-base ml-2 font-poppins">Mentores expertos</p>
                        </div>
                        <div className="flex items-center">
                            <span className="icon-[material-symbols--rocket-launch-outline] text-colorsIcon w-8 h-8 mr-2"></span>
                            <p className="text-colorText text-base sm:text-xl md:text-base ml-2 font-poppins">Vacantes limitadas</p>
                        </div>
                    </div>
                </div>
