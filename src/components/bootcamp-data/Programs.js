        ...
        <div className="px-2 2xl:pt-7 lg:pl-2 xl:pl-20 py-8 lg:py-1 lg:p-5 md:p-12">
          ...
          <div className=" md:w-full flex flex-wrap justify-center lg:gap-x-5 xl:gap-x-10 lg:px-2 xl:px-2">
            ...
            <div className="w-full lg:w-[48%] xl:w-[48%] lg:px-1 mb-4">
              <div className="bg-customBlue text-white rounded-lg p-4 lg:p-6 2xl:p-8 h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4 lg:mb-0">
                  ...
                  <p className="font-poppinsbold text-xl md:text-2xl lg:text-xl xl:text-2xl 2xl:text-2xl md:pr-20">
                    72 horas de sesiones grupales en vivo con tu Deep Mentor.
                  </p>
                </div>
              </div>
            </div>
            {/* Card Azul 2 */}
            <div className="w-full lg:w-[48%] xl:w-[48%] lg:px-1 mb-4">
              <div className="p-4 bg-customBlue text-white rounded-lg lg:p-6 2xl:p-8 h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4 lg:mb-0">
                  ...
                  <p className="font-poppinsbold text-xl md:text-2xl lg:text-xl xl:text-2xl 2xl:text-2xl md:pr-20">
                    12 horas de trabajo de laboratorio en sesión 1 a 1 con tu Buddy.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-[31%] lg:px-0 md:mb-4 md:my-4 mb-0 flex justify-center">
              <div className="p-4 lg:p-4 xl:py-6 2xl:py-8 2xl:p-7 bg-colorsButton text-white rounded-lg h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4">
                  ...
                  <p className="font-poppinsbold  text-black text-xl md:text-lg lg:text-base xl:text-lg 2xl:text-xl md:text-left pl-5 md:pl-6">
            ...
            <div className="w-full lg:w-[31%] lg:px-0 my-4 flex justify-center">
              <div className="p-4 lg:p-4 xl:py-6 2xl:py-8 2xl:p-7 bg-colorsButton text-white rounded-lg h-full flex flex-col justify-between">
                <div className="flex items-center mb-2 md:mb-4">
                  ...
                  <p className="font-poppinsbold text-black text-xl md:text-lg lg:text-base xl:text-lg 2xl:text-xl md:text-left pl-4 md:pl-6">
            ...
            <div className="w-full lg:w-[31%] lg:px-0 md:mb-4 md:my-4 mb-0 flex justify-center">
              <div className="p-4 lg:p-4 xl:py-6 2xl:py-8 2xl:p-7 bg-colorsButton text-white rounded-lg h-full flex flex-col justify-between">
                <div className="flex items-center mb-4">
                  ...
                  <p className="font-poppinsbold text-black text-xl md:text-lg lg:text-base xl:text-lg 2xl:text-xl  text-left pl-6">
